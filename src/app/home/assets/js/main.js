;(function () {
	...
	$(window).load(function() {
		...
		if (WindowWidth > 1200) {
			...
			$(source).attr('src', './assets/weddingfinal.mp4');
			vid.append(source);
			vid.load();
			vid.autoplay = true;
		} else {
	...
	var pageScroll = function() {
		...
		if (WindowWidth > 1200) {
			//It is a small screen
			$(source2).attr('src', 'erntefinal.mp4');
			vid2.append(source2);
			vid2.load();
			vid2.play();
			vid2.autoplay = true;	
	...
	var setcounter = function() {
		...
		$('.dayssince').attr('data-to', Difference_In_Days);
		//alert($('.dayssince').data('to'));
	};
	...
	var countdown = function() {
		...
		var deadline = 'September 12 2020 14:00:00 GMT+0200';
		if (countdown){
